...
class ChangeLogAdmin(admin.ModelAdmin):
    list_display = ('id', 'created_on', 'member', 'description',
                    'curriculum', 'bit', 'subject', 'operation')

admin.site.register(ChangeLog, ChangeLogAdmin)


class CommentAdmin(admin.ModelAdmin):
    list_display = ('id', 'created_on', 'last_modified', 'member',
                    'curriculum', 'bit', 'comment', 'changelog',)
...
class CurriculumAdmin(admin.ModelAdmin):
    list_display = ('id', 'created_on', 'last_modified',
                    'posted_by', 'subject', 'title', 'description')

admin.site.register(Curriculum, CurriculumAdmin)


class MemberInline(admin.ModelAdmin):
    list_display = ('u_id', 'created_on', 'username', 'full_name',
                    'email', 'institution', 'designation', 'image')
